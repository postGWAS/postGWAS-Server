...
public class CaviarService {
    ...
    @Async
    public void caviar(String gwas, String ld, String zscore, String rsid, String c,
        ...
        job.setResult_path("/gwas2gene/caviar/CAVIAR_" + jobid + ".zip");
        job.setDir_path("/gwas2gene/caviar/dir_caviar_" + jobid + "/");
        ...
        jobMapper.updateByPrimaryKey(job);
        String readmePath = "/gwas2gene/caviar/caviar/readme.txt";
        String command = "cp "+ readmePath + " /gwas2gene/caviar/dir_caviar_" + jobid;
        try {
        ...
        String zipName = "CAVIAR_" + jobid + ".zip";
