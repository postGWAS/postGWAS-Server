...
public class FinemapService {
    ...
    @Async
    public void finemap(String gwas, String ld, String beta, String rsid, String chr, String pos, String a1,
                        String a2, String maf, String se, long ng, long c, String jobid, String email){
        Job job = new Job();
        Date date = new Date();
        ...
        job.setResult_path("/gwas2gene/finemap/FINEMAP_" + jobid + ".zip");
        job.setDir_path("/gwas2gene/finemap/dir_finemap_" + jobid + "/");
        ...
        try {
            ...
            String rScriptPath = "/gwas2gene/finemap/";
            String rScript = "finemap.R";
        ...
        jobMapper.updateByPrimaryKey(job);
        String readmePath = "/gwas2gene/finemap/readme.txt";
        String command = "cp "+ readmePath + " /gwas2gene/finemap/dir_finemap_" + jobid;
        try {
        ...
        //压缩结果文件夹
        String folderName = "dir_finemap_" + jobid;
        String zipName = "FINEMAP_" + jobid + ".zip";
        String resultPath = "/gwas2gene/finemap/";
