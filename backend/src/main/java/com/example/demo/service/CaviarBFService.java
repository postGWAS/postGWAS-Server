...
public class CaviarBFService {
    ...
    @Async
    public void caviarBF(String gwas, String ld, String zscore, String rsid, String maxCasual,
                         String ng, String jobid, String email){
        Job job = new Job();
        Date date = new Date();
        SimpleDateFormat dateFormat= new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
        job.setJobid(jobid);
        job.setType("CAVIARBF");
        job.setStatus("Running");
        job.setCreate_time(dateFormat.format(date));
        job.setResult_path("/gwas2gene/caviarBF/CAVIARBF_" + jobid + ".zip");
        job.setDir_path("/gwas2gene/caviarBF/dir_caviar_" + jobid + "/");
        ...
        try {
            ...
            String rScriptPath = "/gwas2gene/caviarBF/";
            String rScript = "caviarBF.R";
        ...
        jobMapper.updateByPrimaryKey(job);
        String readmePath = "/gwas2gene/caviarBF/readme.txt";
        String command = "cp "+ readmePath + " /gwas2gene/caviarBF/dir_caviar_" + jobid;
        try {
        ...
        //压缩结果文件夹
        String folderName = "dir_caviar_" + jobid;
        String zipName = "CAVIARBF_" + jobid + ".zip";
        String resultPath = "/gwas2gene/caviarBF/";
